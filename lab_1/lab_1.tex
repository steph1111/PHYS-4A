...
\begin{document}
  ...
  This is confirmed by graph analyis. We know this because the object's
  position is increasing and the velocity is positive and increasing\\
  ...
  \subsubsection{Graph analysis}
  Graph 4 depicts an object moving down an incline. It comes in contact with somethinhg at the
