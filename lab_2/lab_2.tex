...
\subsection{Calculate the standard error from your data set of 100 times} % 2.9
$$SE = \frac{\sigma}{\sqrt{N}}$$
$$SE = \frac{0.037s}{\sqrt{100}}$$
$$SE = \frac{0.037s}{10}$$
$$SE = \boxed{0.0037s}$$

\subsection{Are the results consistent} % 2.10
If the predicted time ($t_{thy}$) is consistent with the experimentally 
measured time, then the predicted time falls within the 2SE-confidence interval
$$\bar{t} - 2SE \leq t_{thy} \leq \bar{t} + 2SE$$
...
\section{Are the times for the pencil and the shoe consistent?}
